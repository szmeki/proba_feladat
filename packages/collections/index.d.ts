...
export interface paths {
  ...
  "/items/dolgozo": {
    /** List the dolgozo items. */
    get: operations["readItemsDolgozo"];
    /** Create a new dolgozo item. */
    post: operations["createItemsDolgozo"];
  };
  "/items/dolgozo/{id}": {
    /** Retrieve a single dolgozo item by unique identifier. */
    get: operations["readSingleItemsDolgozo"];
    /** Delete an existing dolgozo item. */
    delete: operations["deleteSingleItemsDolgozo"];
    /** Update an existing dolgozo item. */
    patch: operations["updateSingleItemsDolgozo"];
  };
  "/items/fizetes_erkezese": {
    /** List the fizetes_erkezese items. */
    get: operations["readItemsFizetesErkezese"];
    /** Create a new fizetes_erkezese item. */
    post: operations["createItemsFizetesErkezese"];
  };
  "/items/fizetes_erkezese/{id}": {
    /** Retrieve a single fizetes_erkezese item by unique identifier. */
    get: operations["readSingleItemsFizetesErkezese"];
    /** Delete an existing fizetes_erkezese item. */
    delete: operations["deleteSingleItemsFizetesErkezese"];
    /** Update an existing fizetes_erkezese item. */
    patch: operations["updateSingleItemsFizetesErkezese"];
  };
  "/items/lakohely": {
    /** List the lakohely items. */
    get: operations["readItemsLakohely"];
    /** Create a new lakohely item. */
    post: operations["createItemsLakohely"];
  };
  "/items/lakohely/{id}": {
    /** Retrieve a single lakohely item by unique identifier. */
    get: operations["readSingleItemsLakohely"];
    /** Delete an existing lakohely item. */
    delete: operations["deleteSingleItemsLakohely"];
    /** Update an existing lakohely item. */
    patch: operations["updateSingleItemsLakohely"];
  };
  "/items/munkakorok": {
    /** List the munkakorok items. */
    get: operations["readItemsMunkakorok"];
    /** Create a new munkakorok item. */
    post: operations["createItemsMunkakorok"];
  };
  "/items/munkakorok/{id}": {
    /** Retrieve a single munkakorok item by unique identifier. */
    get: operations["readSingleItemsMunkakorok"];
    /** Delete an existing munkakorok item. */
    delete: operations["deleteSingleItemsMunkakorok"];
    /** Update an existing munkakorok item. */
    patch: operations["updateSingleItemsMunkakorok"];
  };
  "/items/szekhely": {
    /** List the szekhely items. */
    get: operations["readItemsSzekhely"];
    /** Create a new szekhely item. */
    post: operations["createItemsSzekhely"];
  };
  "/items/szekhely/{id}": {
    /** Retrieve a single szekhely item by unique identifier. */
    get: operations["readSingleItemsSzekhely"];
    /** Delete an existing szekhely item. */
    delete: operations["deleteSingleItemsSzekhely"];
    /** Update an existing szekhely item. */
    patch: operations["updateSingleItemsSzekhely"];
  };
  "/items/szovetkezet": {
    /** List the szovetkezet items. */
    get: operations["readItemsSzovetkezet"];
    /** Create a new szovetkezet item. */
    post: operations["createItemsSzovetkezet"];
  };
  "/items/szovetkezet/{id}": {
    /** Retrieve a single szovetkezet item by unique identifier. */
    get: operations["readSingleItemsSzovetkezet"];
    /** Delete an existing szovetkezet item. */
    delete: operations["deleteSingleItemsSzovetkezet"];
    /** Update an existing szovetkezet item. */
    patch: operations["updateSingleItemsSzovetkezet"];
  };
  "/activity": {
...
export interface components {
  schemas: {
    ItemsDolgozo: {
      ...
      nev_elotag?: string | null;
      szuletesi_ido?: string | null;
      szuletesi_hely?: string | null;
      telefonszam?: string | null;
      email?: string | null;
      lakohely?: (string | components["schemas"]["ItemsLakohely"]) | null;
      anyja_vezetekneve?: string | null;
      anyja_keresztneve?: string | null;
      taj_szam?: string | null;
      adoazonosito_jel?: string | null;
      szemelyi_igazolvany_szama?: string | null;
      szemelyi_elolap?: (string | components["schemas"]["Files"]) | null;
      szemelyi_hatlap?: (string | components["schemas"]["Files"]) | null;
      allampolgarsag?: string | null;
      azonosito_szelfi?: (string | components["schemas"]["Files"]) | null;
      nev_csoport?: string;
      elerhetosegek?: string;
      kifizetes_kuldese?: (
        | number
        | components["schemas"]["ItemsFizetesErkezese"]
      )[];
    };
    ItemsFizetesErkezese: {
      id?: number;
      kifizetes_modja?: string | null;
      bankszamlaszam?: string | null;
      postai_kifizetes_cime?: string | null;
      hatalyossag_kezdete?: string | null;
      hatalyossag_vege?: string | null;
      dolgozo?: (string | components["schemas"]["ItemsDolgozo"]) | null;
    };
    ItemsLakohely: {
      id?: string;
      telepules?: string | null;
      kozterulet_nev_tipus?: string | null;
      egyeb_emelet_ajto?: string | null;
      hazszam?: number | null;
      iranyitoszam?: number | null;
    };
    ItemsMunkakorok: {
    ...
    ItemsSzovetkezet: {
      /** A szövetkezet rövid neve, ahogy a szóban hivatkozunk rá. */
      rovid_nev?: string;
      /** A szövetkezet teljes cégneve, ahogy az a szerződésekben is szerepel. */
      teljes_nev?: string | null;
      adoszam?: string | null;
      cegjegyzekszam?: string | null;
      szovetkezeti_tipus?: string | null;
      szekhely?: (number | components["schemas"]["ItemsSzekhely"]) | null;
    };
    Activity: {
...
export interface operations {
  ...
  readItemsDolgozo: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsDolgozo"][];
  ...
  createItemsDolgozo: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsDolgozo"][]
          | components["schemas"]["ItemsDolgozo"];
      };
    };
  };
  /** Retrieve a single dolgozo item by unique identifier. */
  readSingleItemsDolgozo: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsDolgozo: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsDolgozo"];
      };
    };
  };
  /** List the fizetes_erkezese items. */
  readItemsFizetesErkezese: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsFizetesErkezese"][];
            meta?: components["x-metadata"];
          };
        };
      };
  ...
  /** Retrieve a single fizetes_erkezese item by unique identifier. */
  readSingleItemsFizetesErkezese: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing fizetes_erkezese item. */
  deleteSingleItemsFizetesErkezese: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing fizetes_erkezese item. */
  updateSingleItemsFizetesErkezese: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsFizetesErkezese"];
      };
    };
  };
  /** List the lakohely items. */
  readItemsLakohely: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsLakohely"][];
            meta?: components["x-metadata"];
          };
        };
      };
  ...
  createItemsLakohely: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsLakohely"][]
          | components["schemas"]["ItemsLakohely"];
      };
    };
  };
  /** Retrieve a single lakohely item by unique identifier. */
  readSingleItemsLakohely: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsLakohely: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsLakohely"];
      };
    };
  };
  /** List the munkakorok items. */
  readItemsMunkakorok: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsMunkakorok"][];
            meta?: components["x-metadata"];
          };
        };
      };
  ...
  createItemsMunkakorok: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsMunkakorok"][]
          | components["schemas"]["ItemsMunkakorok"];
      };
    };
  };
  /** Retrieve a single munkakorok item by unique identifier. */
  readSingleItemsMunkakorok: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsMunkakorok: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsMunkakorok"];
      };
    };
  };
  /** List the szekhely items. */
  readItemsSzekhely: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsSzekhely"][];
            meta?: components["x-metadata"];
          };
        };
      };
  ...
  createItemsSzekhely: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsSzekhely"][]
          | components["schemas"]["ItemsSzekhely"];
      };
    };
  };
  /** Retrieve a single szekhely item by unique identifier. */
  readSingleItemsSzekhely: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsSzekhely: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsSzekhely"];
      };
    };
  };
  /** List the szovetkezet items. */
  readItemsSzovetkezet: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsSzovetkezet"][];
            meta?: components["x-metadata"];
          };
        };
      };
  ...
  createItemsSzovetkezet: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsSzovetkezet"][]
          | components["schemas"]["ItemsSzovetkezet"];
      };
    };
  };
  /** Retrieve a single szovetkezet item by unique identifier. */
  readSingleItemsSzovetkezet: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  updateSingleItemsSzovetkezet: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsSzovetkezet"];
      };
    };
  };
  /** Returns a list of activity actions. */
...
export type Collections = {
  dolgozo: components["schemas"]["ItemsDolgozo"];
  fizetes_erkezese: components["schemas"]["ItemsFizetesErkezese"];
  lakohely: components["schemas"]["ItemsLakohely"];
  munkakorok: components["schemas"]["ItemsMunkakorok"];
  szekhely: components["schemas"]["ItemsSzekhely"];
  szovetkezet: components["schemas"]["ItemsSzovetkezet"];
};